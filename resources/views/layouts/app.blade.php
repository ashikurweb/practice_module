                ...
                <div class="hidden lg:flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ userOpen: false }">
                        ...
                        <div 
                            ...
                            <button class="flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50/50 transition-colors w-full text-left group">
            ...
            <div class="container mx-auto px-4 py-6">
                ...
                <div class="border-t border-white/20 pt-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <button class="flex items-center gap-3 px-3 py-2 text-red-600 hover:bg-red-50/50 rounded-lg transition-colors text-left w-full">
