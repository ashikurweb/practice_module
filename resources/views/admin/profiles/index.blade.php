<x-admin.layouts.admin>
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-32 h-32 bg-gray-200 rounded-full flex items-center justify-center mb-4 overflow-hidden">
                                ...
                                <svg class="w-16 h-16 text-gray-400 {{ $user->profile_image ? 'hidden' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2 space-y-8">
             ...
             <div class="bg-white rounded-2xl  max-w-2xl mx-auto shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
    ...
    <script>
        ...
        function previewImage(input) {
            ...
            const defaultIcon = preview ? preview.nextElementSibling : null;
