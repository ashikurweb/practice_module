        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 hover-glow shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
                <div class="p-5 pb-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Organization Profile</h3>
                    <p class="text-gray-500 text-sm mb-4">Update your organization information and preferences</p>
